...
<div class="limiter">
    <div class="container-login100" style="background-image: url('img/carbgdash.jpg');">
        <div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
            ...
            $qry = mysqli_query($con,"SELECT * FROM user WHERE  password='$passwrd' ");
            $qry1 = mysqli_num_rows($qry);
            if($qry1)
            {
                $uid = $_SESSION['log']['useruid'];
            $qry2 = mysqli_query($con,"SELECT * FROM logtable WHERE useruid='$uid' ORDER BY id DESC");
            $qry3 = mysqli_num_rows($qry2);
            if($qry3)
